// Importa o arquivo de estilos (CSS) exclusivo desta página Home
import './style.css';

// Importa as imagens da pasta 'assets' para que o React consiga carregá-las corretamente
...
// Cria e exporta a função principal que desenha a página Home
export default function Home() {
  return (
    // Tag <main> indica o conteúdo principal e central da página
    <main className="conteudo-home">
      
      {/* SEÇÃO DE INTRODUÇÃO: O banner de boas-vindas do topo */}
      ...
      {/* SEÇÃO MÃE: Cartão com o texto dedicado à sua mãe */}
      ...
      {/* SEÇÃO FAMÍLIA: Cartão com os textos dedicados aos seus irmãos */}
      <section id="familia" className="cartao-secao">
        <h3>✨ Minha Família: Meus Irmãos, My Inspiração</h3>
        
        {/* Parágrafo 1 do Irmão */}
        <p>
        ...
        {/* Parágrafo 2 do Irmão (com estilo em linha para criar um espaço extra embaixo) */}
        ...
        {/* Linha horizontal divisória (<hr>) para separar o texto do irmão e da irmã */}
        ...
        {/* Parágrafo 2 da Irmã (história sobre o sobrinho e a coleção de Hot Wheels) */}
        <p>
      ...
      {/* GALERIA DE MEMÓRIAS: Exibe as fotos estruturadas em formato de molduras */}
      <section id="galeria" className="cartao-secao">
        ...
        {/* Contêiner que agrupa todas as fotos e ativa o formato de grade (Grid) */}
      ...
      {/* DEDICATÓRIAS EM VÍDEO: Incorpora o player do YouTube */}
      <section id="video" className="cartao-secao">
        <h3>🎥 Música especial </h3>
        <p>Uma simples música que trás lembranças.</p>
        
        {/* O contêiner do vídeo, essencial para controlar a proporção da tela no mobile */}
        <div className="container-video">
          <iframe 
            src="https://www.youtube.com/embed/qEm98jLkeHI" 
            title="Dedicatória Especial"
            // Permissões do player para habilitar recursos do YouTube
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
            allowFullScreen // Permite colocar o vídeo em tela cheia
          ></iframe>
        </div>
      </section>
